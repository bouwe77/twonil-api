...
{
   public interface IPenaltyTaker
   {
      void TakePenalties(Match match);
   }

   public class PenaltyTaker : IPenaltyTaker
   {
      ...
      internal PenaltyTaker(IMatchPlayerRandomizer randomizer)
      {
