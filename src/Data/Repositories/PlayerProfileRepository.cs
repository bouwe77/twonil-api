...
namespace TwoNil.Data.Repositories
{
    public interface IPlayerProfileRepository
    {
        ...
        PlayerProfile GetCentreForwardProfile();
        PlayerProfile GetDefensiveMidfieldProfile();
        PlayerProfile GetForwardMidfieldProfile();
        PlayerProfile GetGoalkeeperProfile();
        PlayerProfile GetStrikerProfile();
        PlayerProfile GetSweeperProfile();
        PlayerProfile GetVersatileProfile();
        PlayerProfile GetWideMidfieldProfile();
        PlayerProfile GetWingBackProfile();
        PlayerProfile GetWingerProfile();
    }

    public class PlayerProfileRepository : MemoryRepository<PlayerProfile>, IPlayerProfileRepository
    {
